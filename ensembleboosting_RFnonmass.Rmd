...
create_ensemble <- function(dat, particvfoldK, cvK){
  ...
  for(r in 1:cvK){
    ...
    for(k in 1:nrow(grd)){
      ...
      # for train
      ROCF_train <- roc(perf$trainprob$obs, perf$trainprob$C, col="#000086", main=paste0("mass ROC T=",T," lrate=",lrate," cv=",r))
      ...
      # for test
      #par(new=TRUE)
      ROCF_test <- roc(perf$testprob$obs, perf$testprob$C, col="#860000", main=paste0("ROC T=",T," lrate=",lrate," cv=",r))
